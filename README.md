...
| 🐝 **Swarm Child Tracking** | Counts sub-agents inside each Stampede/metaswarm commander from `child-agents.jsonl`, with recent child rows plus full per-commander totals |
